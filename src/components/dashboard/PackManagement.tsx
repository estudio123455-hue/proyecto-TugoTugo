...
export default function PackManagement({ establishmentId }: PackManagementProps) {
            ...
            <div key={pack.id} className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid md:grid-cols-4 gap-4 mb-4">
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="font-semibold text-green-600">${pack.discountedPrice}</span>
                ...
                <div>
                  ...
                  <div className="text-sm">
                    {new Date(pack.availableFrom).toLocaleDateString()} - {new Date(pack.availableUntil).toLocaleDateString()}
                  </div>
                </div>
                <div>
                  <span className="text-sm text-gray-500">Pickup Time</span>
                  <div className="text-sm">{pack.pickupTimeStart} - {pack.pickupTimeEnd}</div>
                </div>
              </div>
