  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        if (loginType === 'restaurant' && session?.user?.role !== 'ESTABLISHMENT') {
          setError('Esta cuenta no es de restaurante. Usa el login de cliente.')
          setIsLoading(false)
          return
        }
        
        if (loginType === 'customer' && session?.user?.role === 'ESTABLISHMENT') {
      ...
      <div className="flex min-h-full flex-col justify-center py-12 px-6">
        ...
        <div className="max-w-md mx-auto text-center mb-12">
          ...
          <p className="text-sm text-gray-500">
            ¿No tienes cuenta?{' '}
            <Link href="/auth/signup" className="font-semibold text-fresh-600 hover:text-fresh-700 transition-colors">
        ...
        <div className="max-w-md mx-auto mb-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-6 text-center">Selecciona tu tipo de cuenta</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-white">
                  <div className="font-semibold">
                    {loginType === 'customer' ? 'Acceso Cliente' : 'Acceso Restaurante'}
                  </div>
                  <div className="text-sm opacity-90">
                    {loginType === 'customer' ? 'Encuentra packs cerca' : 'Gestiona tu negocio'}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
                ...
                >
                  {isLoading ? (
                    ...
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <span>{loginType === 'restaurant' ? 'Acceder como Restaurante' : 'Acceder como Cliente'}</span>
                    </div>
                  )}
                </button>
              </form>
              ...
              <div className="mt-6 text-center">
                <Link href="/auth/forgot-password" className="text-sm text-gray-600 hover:text-fresh-600 transition-colors">
