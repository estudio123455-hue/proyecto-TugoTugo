...
export default function SignUpNew() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Registro directo sin verificación por email
              ...
              <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center text-white">
                <div className="mb-8">
                  ...
                  <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                    ...
                    Cada pack que rescatas ayuda al planeta y a tu bolsillo.
                  </p>
                </div>
                ...
                <div className="space-y-4 text-white/80">
                  <div className="flex items-center gap-3">
                    ...
                    <span>Packs sorpresa con hasta 70% descuento</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                      <span>🌍</span>
                    </div>
                    <span>Contribuye a un planeta más sostenible</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                      <span>⚡</span>
                    </div>
                    <span>Registro rápido y completamente gratis</span>
                  </div>
                </div>
              </div>
