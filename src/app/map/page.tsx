  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[calc(100vh-4rem)]">
        ...
        {/* Sidebar */}
        <div className={`absolute top-0 right-0 h-full w-full md:w-96 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-10 ${
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="bg-green-500 text-white p-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold">
                {selectedEstablishment ? selectedEstablishment.name : 'Available Packs'}
              </h2>
              <button
              ...
              {selectedEstablishment ? (
                <div className="space-y-4">
                  <div className="mb-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">{selectedEstablishment.name}</h3>
                  ...
                  {selectedEstablishment.packs.filter(pack => pack.quantity > 0).length > 0 ? (
                    <div className="space-y-4">
                    ...
                    <div className="text-center py-8">
                      <p className="text-gray-500">No packs available at this establishment.</p>
                    </div>
                  )}
                </div>
              ) : (
                <div className="space-y-4">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">All Available Packs</h3>
                  ...
                  {establishments.flatMap(est => 
                    ...
                    <div className="text-center py-8">
                      <p className="text-gray-500">No packs available right now.</p>
