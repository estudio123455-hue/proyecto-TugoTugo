            ...
            <section>
              ...
              <div className="prose prose-gray max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  ...
                  a través de nuestra aplicación web, aplicaciones móviles y
              ...
              <div className="space-y-6">
                <div className="bg-fresh-50 rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      • <strong>Datos de cuenta:</strong> Nombre, email,
                      contraseña (encriptada)
                    </li>
                    <li>
                      • <strong>Información de perfil:</strong> Preferencias
                      alimentarias, foto de perfil (opcional)
                    </li>
                    <li>
                      • <strong>Información de pago:</strong> Datos de tarjeta
                      (procesados por Stripe, no almacenados por nosotros)
                    </li>
                    <li>
                      • <strong>Comunicaciones:</strong> Mensajes que nos
                      envías, reseñas, comentarios
                    </li>
                    <li>
                      • <strong>Para restaurantes:</strong> Información del
                      negocio, licencias, datos fiscales
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-warm-50 rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      • <strong>Datos de ubicación:</strong> Ubicación
                      aproximada para mostrarte restaurantes cercanos
                    </li>
                    <li>
                      • <strong>Datos de uso:</strong> Páginas visitadas, tiempo
                      en la app, clics, interacciones
                    </li>
                    <li>
                    ...
                    <li>
                      • <strong>Datos de transacciones:</strong> Historial de
                      pedidos, fechas, montos
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-50 rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      • <strong>Redes sociales:</strong> Si eliges iniciar
                      sesión con Google/Facebook
                    </li>
                    <li>
                      • <strong>Servicios de pago:</strong> Confirmaciones de
                      pago de Stripe
                    </li>
                    <li>
                      • <strong>Servicios de mapas:</strong> Datos de ubicación
            ...
            <section>
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
                ...
                <p className="text-red-800">
                  No vendemos, alquilamos ni comercializamos tu información
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-fresh-500 pl-6">
                  <h3 className="font-semibold text-gray-900 mb-2">
                    ✅ Con restaurantes socios:
                  </h3>
                  <p className="text-gray-700">
                    Compartimos información necesaria para completar tu pedido
                ...
                <div className="border-l-4 border-warm-500 pl-6">
                  ...
                  <p className="text-gray-700">
                    Stripe para pagos, servicios de email, hosting (todos con
                ...
                <div className="border-l-4 border-blue-500 pl-6">
                  ...
                  <p className="text-gray-700">
                    Solo cuando sea requerido por ley o para proteger nuestros
                    derechos legítimos.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="bg-yellow-50 rounded-xl p-6">
                <p className="text-gray-700 mb-4">
                  ...
                  experiencia, recordar tus preferencias y analizar cómo usas
                  nuestros servicios.
                </p>
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6">
                  ...
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Nos ayudan a entender cómo usas la app
                    </p>
                  </div>
                  <div className="bg-white rounded-lg p-4">
                    <h4 className="font-semibold text-gray-900 mb-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Mantenidos mientras tu cuenta esté activa + 3 años
                        después del cierre.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Conservados durante 7 años por requisitos fiscales y
                        legales.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Anonimizados y agregados, conservados indefinidamente
              ...
              <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    className="inline-flex items-center text-fresh-600 hover:text-fresh-700"
                  >
              ...
              <div className="bg-gradient-to-r from-fresh-50 to-warm-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-gray-700">
                    ...
                    <a
                      href="mailto:estudio.123455@gmail.com"
                      className="ml-2 text-fresh-600 hover:text-fresh-700"
                    >
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <p className="text-gray-700">
                  ...
                  razones operativas, legales o regulatorias. Te notificaremos
                  sobre cambios significativos por email o mediante un aviso
                  destacado en nuestra plataforma.
                </p>
